...
export const movieAdaptations: MovieAdaptation[] = [
  {
    ...
    movieTitle: 'Normal People (Series)',
    author: 'Sally Rooney',
    genre: 'Romance',
    mood: 'melancholic',
    releaseYear: 2020,
    description: 'An intimate portrayal of two people navigating love and identity.',
    bookCoverUrl: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300&h=450&fit=crop',
    moviePosterUrl: 'https://image.tmdb.org/t/p/w500/6vHBqcMgMhOL0PB1EgWSfblUEAp.jpg',
    popularity: 95,
    recommended: true,
    director: 'Lenny Abrahamson, Hettie Macdonald',
    cast: ['Daisy Edgar-Jones', 'Paul Mescal'],
    movieRating: 8.4,
    movieReview: 'Tender, raw, and emotionally devastating in the best way.',
  },
  {
    id: 'ma2',
    bookTitle: 'Little Women',
    movieTitle: 'Little Women (2019)',
    author: 'Louisa May Alcott',
    genre: 'Classics',
    mood: 'heartwarming',
    releaseYear: 2019,
    description: 'Greta Gerwig\'s beloved adaptation of the timeless classic.',
    bookCoverUrl: 'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=300&h=450&fit=crop',
    moviePosterUrl: 'https://image.tmdb.org/t/p/w500/yn5ihODtZ7ofn8pDYfxCmxh8AXI.jpg',
    popularity: 90,
    recommended: true,
    director: 'Greta Gerwig',
    cast: ['Saoirse Ronan', 'Emma Watson', 'Florence Pugh', 'Timothée Chalamet'],
    movieRating: 7.8,
    movieReview: 'Warm, elegant, and full of heart, with stunning performances.',
  },
  {
    id: 'ma3',
    bookTitle: 'Daisy Jones & The Six',
    movieTitle: 'Daisy Jones & The Six (Series)',
    author: 'Taylor Jenkins Reid',
    genre: 'Literary Fiction',
    mood: 'nostalgic',
    releaseYear: 2023,
    description: 'The rise and fall of a fictional rock band in the 1970s.',
    bookCoverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=450&fit=crop',
    moviePosterUrl: 'https://image.tmdb.org/t/p/w500/dGmGSGkcQRATagV4Rl2YMHkpCID.jpg',
    popularity: 88,
    recommended: true,
    director: 'Scott Neustadter, Michael H. Weber',
    cast: ['Riley Keough', 'Sam Claflin'],
    movieRating: 8.1,
    movieReview: 'Stylish, messy, and immersive — perfect rock-and-roll drama.',
  },
  {
    id: 'ma4',
    ...
    bookCoverUrl: 'https://images.unsplash.com/photo-1524578271613-d550eacbd6a4?w=300&h=450&fit=crop',
    moviePosterUrl: 'https://image.tmdb.org/t/p/w500/5h6Xiu1iXgsR1wFa1syZ8wqH0U4.jpg',
    popularity: 85,
    recommended: false,
    director: 'Baz Luhrmann',
    cast: ['Leonardo DiCaprio', 'Carey Mulligan', 'Tobey Maguire'],
    movieRating: 7.2,
    movieReview: 'Lavish visuals and spectacle make this adaptation unforgettable.',
  },
  {
    id: 'ma5',
    ...
    mood: 'emotional',
    releaseYear: 2024,
    description: 'The highly anticipated film adaptation of the BookTok phenomenon.',
    bookCoverUrl: 'https://images.unsplash.com/photo-1532012197267-da84d127e765?w=300&h=450&fit=crop',
    moviePosterUrl: 'https://image.tmdb.org/t/p/w500/AjV6jFJ2YFIluYo4GQf13AA1tqu.jpg',
    popularity: 92,
    recommended: true,
    director: 'Justin Baldoni',
    cast: ['Blake Lively', 'Justin Baldoni'],
    movieRating: 6.8,
    movieReview: 'Emotional and visually polished, with strong fan interest.',
  },
  {
    id: 'ma6',
    bookTitle: 'Lessons in Chemistry',
    movieTitle: 'Lessons in Chemistry (Series)',
    author: 'Bonnie Garmus',
    genre: 'Literary Fiction',
    mood: 'empowering',
    releaseYear: 2023,
    description: 'Brie Larson stars in this witty feminist period drama.',
    bookCoverUrl: 'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=300&h=450&fit=crop',
    moviePosterUrl: 'https://image.tmdb.org/t/p/w500/7xyw5dKKuVf0oA0f6mF4Pjk6Hoy.jpg',
    popularity: 87,
    recommended: true,
    director: 'Lee Eisenberg',
    cast: ['Brie Larson', 'Lewis Pullman'],
    movieRating: 8.2,
    movieReview: 'Sharp, charming, and empowering with a standout lead performance.',
  },
  {
    id: 'ma7',
    ...
    bookCoverUrl: 'https://images.unsplash.com/photo-1476275466078-4007374efbbe?w=300&h=450&fit=crop',
    moviePosterUrl: 'https://image.tmdb.org/t/p/w500/sGjIvtVvTlWnia2zfJfHz81pZ9Q.jpg',
    popularity: 93,
    recommended: true,
    director: 'Joe Wright',
    cast: ['Keira Knightley', 'Matthew Macfadyen'],
    movieRating: 7.8,
    movieReview: 'Beautifully shot, emotionally rich, and endlessly rewatchable.',
  },
  {
    id: 'ma8',
    bookTitle: 'The Song of Achilles',
    movieTitle: 'The Song of Achilles (TBA)',
    author: 'Madeline Miller',
    genre: 'Classics',
    mood: 'epic',
    releaseYear: 2025,
    description: 'The long-awaited adaptation of the beloved mythology retelling.',
    bookCoverUrl: 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=300&h=450&fit=crop',
    ...
    cast: ['TBA'],
    movieRating: 0,
    movieReview: 'Poster not available yet, so this remains a placeholder until officially released.',
  },
];
