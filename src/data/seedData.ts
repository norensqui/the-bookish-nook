  ...
  tiktok: [
    {
      ...
      reason: 'BookTok sensation with over 2M videos',
      platform: 'tiktok',
      genre: 'Fantasy',
      goodreadsRating: 4.19,
      review: 'A lush fantasy romance with high stakes, addictive tension, and a world readers love to disappear into.',
    },
    {
      id: 't2',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300&h=450&fit=crop',
      reason: 'Emotional rollercoaster everyone is crying over',
      platform: 'tiktok',
      genre: 'Romance',
      goodreadsRating: 4.14,
      review: 'An emotional and highly discussed contemporary novel that sparks strong reactions and heartfelt conversations.',
    },
    {
      id: 't3',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=450&fit=crop',
      reason: 'The most devastating love story on BookTok',
      platform: 'tiktok',
      genre: 'Classics',
      goodreadsRating: 4.34,
      review: 'A lyrical, heartbreaking retelling of myth that readers often describe as unforgettable and deeply moving.',
    },
    {
      id: 't4',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=300&h=450&fit=crop',
      reason: 'Rock and roll era vibes everyone loves',
      platform: 'tiktok',
      genre: 'Literary Fiction',
      goodreadsRating: 4.20,
      review: 'Fast-paced, glamorous, and immersive, with a documentary style that makes the band feel real.',
    },
    {
      id: 't5',
      title: 'Beach Read',
      author: 'Emily Henry',
      coverUrl: 'https://images.unsplash.com/photo-1524578271613-d550eacbd6a4?w=300&h=450&fit=crop',
      reason: 'The ultimate summer romance read',
      platform: 'tiktok',
      genre: 'Romance',
      goodreadsRating: 4.02,
      review: 'A witty and emotional romance that balances charm, grief, and chemistry beautifully.',
    },
  ],
  ...
  reddit: [
    {
      ...
      author: 'Andy Weir',
      coverUrl: 'https://images.unsplash.com/photo-1532012197267-da84d127e765?w=300&h=450&fit=crop',
      reason: 'r/books favorite sci-fi of the decade',
      platform: 'reddit',
      genre: 'Science Fiction',
      goodreadsRating: 4.52,
      review: 'A clever, entertaining sci-fi adventure full of problem-solving, humor, and big emotional payoff.',
    },
    {
      id: 'r2',
      title: 'Piranesi',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1476275466078-4007374efbbe?w=300&h=450&fit=crop',
      reason: 'Hauntingly beautiful world-building',
      platform: 'reddit',
      genre: 'Fantasy',
      goodreadsRating: 4.23,
      review: 'Quiet, surreal, and haunting, this novel rewards patient readers with a deeply original atmosphere.',
    },
    {
      id: 'r3',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=300&h=450&fit=crop',
      reason: 'Nobel laureate\'s masterful AI story',
      platform: 'reddit',
      genre: 'Literary Fiction',
      goodreadsRating: 3.83,
      review: 'A reflective and tender novel about love, loneliness, and what it means to be human.',
    },
    {
      id: 'r4',
      ...
      author: 'V.E. Schwab',
      coverUrl: 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=300&h=450&fit=crop',
      reason: 'Fantasy that sparked a massive discussion thread',
      platform: 'reddit',
      genre: 'Fantasy',
      goodreadsRating: 4.18,
      review: 'A romantic, melancholic fantasy with an unforgettable premise and atmospheric storytelling.',
    },
    {
      id: 'r5',
      title: 'Circe',
      author: 'Madeline Miller',
      coverUrl: 'https://images.unsplash.com/photo-1589998059171-988d887df646?w=300&h=450&fit=crop',
      reason: 'Feminist mythology retelling r/books adores',
      platform: 'reddit',
      genre: 'Classics',
      goodreadsRating: 4.23,
      review: 'A beautifully written myth retelling centered on power, exile, womanhood, and self-discovery.',
    },
  ],
  ...
  pinterest: [
    {
      ...
      author: 'Donna Tartt',
      coverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=450&fit=crop',
      reason: 'Dark academia aesthetic icon',
      platform: 'pinterest',
      genre: 'Mystery',
      goodreadsRating: 4.17,
      review: 'Dark, stylish, and cerebral, this is the novel many readers associate with the dark academia mood.',
    },
    {
      id: 'p2',
      title: 'Normal People',
      author: 'Sally Rooney',
      coverUrl: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300&h=450&fit=crop',
      reason: 'Most pinned book aesthetic of 2024',
      platform: 'pinterest',
      genre: 'Literary Fiction',
      goodreadsRating: 3.82,
      review: 'A minimal, intimate novel about miscommunication, vulnerability, and complicated love.',
    },
    {
      id: 'p3',
      title: 'Little Women',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=300&h=450&fit=crop',
      reason: 'Cottagecore reading list essential',
      platform: 'pinterest',
      genre: 'Classics',
      goodreadsRating: 4.14,
      review: 'Warm, timeless, and comforting, with beloved characters and a homey emotional core.',
    },
    {
      id: 'p4',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1524578271613-d550eacbd6a4?w=300&h=450&fit=crop',
      reason: 'Art deco inspired boards everywhere',
      platform: 'pinterest',
      genre: 'Classics',
      goodreadsRating: 3.93,
      review: 'Elegant and tragic, this classic remains popular for its mood, symbolism, and iconic imagery.',
    },
    {
      id: 'p5',
      ...
      author: 'Jane Austen',
      coverUrl: 'https://images.unsplash.com/photo-1532012197267-da84d127e765?w=300&h=450&fit=crop',
      reason: 'Regencycore aesthetic goes viral',
      platform: 'pinterest',
      genre: 'Romance',
      goodreadsRating: 4.28,
      review: 'Sharp, romantic, and endlessly re-readable, with sparkling dialogue and timeless chemistry.',
    },
  ],
  ...
  twitter: [
    {
      ...
      coverUrl: 'https://images.unsplash.com/photo-1476275466078-4007374efbbe?w=300&h=450&fit=crop',
      reason: 'Pulitzer Prize winner dominating book twitter',
      platform: 'twitter',
      genre: 'Literary Fiction',
      goodreadsRating: 4.41,
      review: 'An expansive, emotionally powerful novel praised for its voice, scope, and social depth.',
    },
    {
      id: 'x2',
      title: 'Trust',
      author: 'Hernan Diaz',
      coverUrl: 'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=300&h=450&fit=crop',
      reason: 'Literary fiction that sparked fierce debates',
      platform: 'twitter',
      genre: 'Literary Fiction',
      goodreadsRating: 3.81,
      review: 'Layered and intellectually rich, this novel plays with power, wealth, and narrative control.',
    },
    {
      id: 'x3',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=300&h=450&fit=crop',
      reason: 'Oprah pick everyone is discussing',
      platform: 'twitter',
      genre: 'Literary Fiction',
      goodreadsRating: 4.32,
      review: 'A sweeping family saga praised for its humanity, richness, and emotional resonance.',
    },
    {
      id: 'x4',
      title: 'Babel',
      author: 'R.F. Kuang',
      coverUrl: 'https://images.unsplash.com/photo-1589998059171-988d887df646?w=300&h=450&fit=crop',
      reason: 'Academic fantasy with sharp social commentary',
      platform: 'twitter',
      genre: 'Fantasy',
      goodreadsRating: 4.17,
      review: 'A bold and intelligent fantasy about language, empire, and resistance, with a strong dark-academia feel.',
    },
    {
      id: 'x5',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=450&fit=crop',
      reason: 'Mind-bending time travel literary fiction',
      platform: 'twitter',
      genre: 'Literary Fiction',
      goodreadsRating: 4.03,
      review: 'Elegant and unsettling, this quiet sci-fi novel explores time, memory, and connection.',
    },
  ],
  ...
  instagram: [
    {
      ...
      author: 'Taylor Jenkins Reid',
      coverUrl: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300&h=450&fit=crop',
      reason: 'Most Instagrammed beach read cover',
      platform: 'instagram',
      genre: 'Romance',
      goodreadsRating: 4.07,
      review: 'A glamorous and emotional family drama with a summery setting and page-turning pace.',
    },
    {
      id: 'i2',
      ...
      author: 'John Green',
      coverUrl: 'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=300&h=450&fit=crop',
      reason: 'Beautiful essays perfect for bookstagram flatlays',
      platform: 'instagram',
      genre: 'Non-Fiction',
      goodreadsRating: 4.36,
      review: 'Thoughtful, warm, and witty essays that mix the personal with the universal in a very readable way.',
    },
    {
      id: 'i3',
      title: 'Hamnet',
      ...
      coverUrl: 'https://images.unsplash.com/photo-1524578271613-d550eacbd6a4?w=300&h=450&fit=crop',
      reason: 'Stunning cover dominating bookstagram',
      platform: 'instagram',
      genre: 'Literary Fiction',
      goodreadsRating: 4.09,
      review: 'A lyrical historical novel rich in atmosphere, grief, and intimate family emotion.',
    },
    {
      id: 'i4',
      ...
      author: 'Sally Rooney',
      coverUrl: 'https://images.unsplash.com/photo-1532012197267-da84d127e765?w=300&h=450&fit=crop',
      reason: 'Minimalist cover art everyone is posting',
      platform: 'instagram',
      genre: 'Literary Fiction',
      goodreadsRating: 3.67,
      review: 'A reflective, conversation-driven novel about friendship, love, work, and modern uncertainty.',
    },
    {
      id: 'i5',
      ...
      author: 'Paula McLain',
      coverUrl: 'https://images.unsplash.com/photo-1476275466078-4007374efbbe?w=300&h=450&fit=crop',
      reason: 'Parisian aesthetic bookstagram favorite',
      platform: 'instagram',
      genre: 'Romance',
      goodreadsRating: 3.80,
      review: 'A stylish historical novel that blends romance, ambition, and literary history.',
    },
  ],
};
...
export const topPicks: TrendingBook[] = [
  {
    ...
    author: 'Sally Rooney',
    coverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=450&fit=crop',
    reason: 'A masterful exploration of grief and connection',
    platform: 'global',
    genre: 'Literary Fiction',
    goodreadsRating: 4.08,
    review: 'An intimate and emotionally observant novel about grief, love, distance, and complicated human connection.',
  },
  {
    id: 'tp2',
    title: 'James',
    ...
    coverUrl: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300&h=450&fit=crop',
    reason: 'Reimagining a classic with stunning depth',
    platform: 'global',
    genre: 'Classics',
    goodreadsRating: 4.35,
    review: 'A brilliant reimagining that feels sharp, literary, and deeply relevant while still being gripping to read.',
  },
  {
    id: 'tp3',
    title: 'All Fours',
    author: 'Miranda July',
    coverUrl: 'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=300&h=450&fit=crop',
    reason: 'Bold and unapologetically original',
    platform: 'global',
    genre: 'Literary Fiction',
    goodreadsRating: 3.92,
    review: 'Strange, bold, and intimate, this is the kind of novel that starts conversations and stays in your head.',
  },
  {
    id: 'tp4',
    title: 'The Women',
    ...
    coverUrl: 'https://images.unsplash.com/photo-1524578271613-d550eacbd6a4?w=300&h=450&fit=crop',
    reason: 'Powerful historical fiction at its finest',
    platform: 'global',
    genre: 'Literary Fiction',
    goodreadsRating: 4.61,
    review: 'A sweeping and emotional historical novel that readers praise for its intensity and heart.',
  },
  {
    id: 'tp5',
    title: 'Orbital',
    ...
    coverUrl: 'https://images.unsplash.com/photo-1532012197267-da84d127e765?w=300&h=450&fit=crop',
    reason: 'Booker Prize winner — hauntingly poetic',
    platform: 'global',
    genre: 'Literary Fiction',
    goodreadsRating: 3.87,
    review: 'A contemplative, poetic novel with a quiet intensity and a very distinct literary voice.',
  },
];
