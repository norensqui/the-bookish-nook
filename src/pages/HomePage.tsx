...
import homeBanner from '@/assets/illustrations/cozy-nook.jpg';
...
export default function HomePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 space-y-12">
      ...
      <PageBanner
        image={homeBanner}
        title="Your cozy corner for book discovery"
        subtitle={`Welcome back, ${settings.displayName} — track your reading, discover books, and curate your library.`}
      />
